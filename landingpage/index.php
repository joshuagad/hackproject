...
<html lang="en">
    <head>
        ...
        <title>International Justice Mission</title>
    ...
    <body>
        ...
        <header class="main_menu_area">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="#"><img src="img/logo1.png" style="height="20%", width="20%;"" alt=""></a>
        ...
        <section class="banner_area">
            <div class="container">
                <div class="banner_inner_text">
                    ...
                    <p>Fighting Cybersex Trafficking</p>
                </div>
            </div>
        </section>        
                ...
                <div class="row get_touch_inner">
                    <div class="col-lg-6">
                        <form class="contact_us_form row" action="../view/submit.php" method="get" id="contactForm" novalidate="novalidate">
							...
							<br>
							<input type="checkbox" id="" value="">I'm not a Robot
                    ...
                    <div class="col-lg-6">
                        <div class="touch_details">
                            <div class="l_title">
                                ...
                                <h6>Say hello</h6>
                                <h2>Get in touch, send us an e-mail, report or call us</h2>
                            </div>
                            <p>Don't be afraid to report.</p>
                            <a href="#"><h5>Call us now</h5></a>
                            <a href="#"><h4>703.465.5495</h4></a>
                        </div>
                    </div>
                </div>
            </div>
